...
export default function Service() {
  return (
    <div className="flex flex-wrap shadow-md lg:flex-row justify-center items-center sm:p-2 md:p-10 mt-10 gap-6 lg:gap-8 bg-white rounded-md border border-slate-200">
